...
public class SizeLimitActivity extends Activity
    ...
    private void showDialog(Cursor cursor) {
        ...
        String queueText = getString(R.string.keyshare_download_button_queue_for_wifi);
        boolean isWifiRequired =
            mCurrentIntent.getExtras().getBoolean(DownloadInfo.EXTRA_IS_WIFI_REQUIRED);

        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        if (isWifiRequired) {
            builder.setTitle(R.string.keyshare_download_wifi_required_title)
                    .setMessage(getString(R.string.keyshare_download_wifi_required_body, sizeString, queueText))
                    .setPositiveButton(R.string.keyshare_download_button_queue_for_wifi, this)
                    .setNegativeButton(R.string.keyshare_download_button_cancel_download, this);
        } else {
            builder.setTitle(R.string.keyshare_download_wifi_recommended_title)
                    .setMessage(getString(R.string.keyshare_download_wifi_recommended_body, sizeString, queueText))
                    .setPositiveButton(R.string.keyshare_download_button_start_now, this)
                    .setNegativeButton(R.string.keyshare_download_button_queue_for_wifi, this);
        }
